...
def main():
    ...
    try:
        ...
        # CRÍTICA APLICADA: Instanciando modelo base adequado para LongLLMLingua (Requer VRAM massiva)
        # Atenção: Você precisará ter acesso/token do HuggingFace para baixar modelos Llama restritos,
        # ou pode usar "huggyllama/llama-7b" / "NousResearch/Llama-2-7b-hf" como alternativas.
        compressor = PromptCompressor(
            model_name="NousResearch/Llama-2-7b-hf", 
            device_map="cuda" # Sem use_llmlingua2=True
        )
    ...
    for file_path in tqdm(files_to_process):
        ...
        for func_tuple in functions:
            ...
            try:
                # O LongLLMLingua exige que informemos explicitamente a instrução e a pergunta
                ...
                # Gargalo Crítico de Processamento (VRAM/GPU)
                compressed_results = compressor.compress_prompt(
                    context=[raw_context], # LongLLMLingua muitas vezes prefere listas de blocos
                ...
                # Você vai precisar disto mais do que nunca com o LongLLMLingua
                gc.collect()
